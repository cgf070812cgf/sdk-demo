...
const createMarketAndDeployPool = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    const { slug, description, oracle, period, categories, advised, endpoint, seed, question, timestamp, authorized, court, amounts, baseAssetAmount, weights, keep, } = opts;
    ...
    const kp = keep.split(",");
    const poolId = yield sdk.models.createCpmmMarketAndDeployAssets(signer, oracle, marketPeriod, advised ? "Advised" : "Permissionless", marketType, mdm, amts, baseAssetAmount, wts, kp, metadata, false);
    if (!poolId) {
        console.log(`Market creation failed!`);
    }
    process.exit(0);
});
exports.default = createMarketAndDeployPool;
//# sourceMappingURL=createMarketAndDeployPool.js.map