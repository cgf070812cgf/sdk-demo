...
const rejectMarket = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield market.reject(signer, false);
    console.log(res);
    return;
});
exports.default = rejectMarket;
//# sourceMappingURL=rejectMarket.js.map