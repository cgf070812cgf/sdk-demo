...
const reportMarket = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield market.reportOutcome(signer, outcomeReport, false);
    console.log(res);
    return;
});
exports.default = reportMarket;
//# sourceMappingURL=reportMarket.js.map