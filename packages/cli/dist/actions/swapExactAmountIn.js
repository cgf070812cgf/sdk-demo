...
const swapExactAmountIn = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield pool.swapExactAmountIn(signer, assetIn, assetAmountIn, assetOut, minAmountOut, maxPrice, false);
    console.log(res);
});
exports.default = swapExactAmountIn;
//# sourceMappingURL=swapExactAmountIn.js.map