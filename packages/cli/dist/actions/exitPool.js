...
const exitPool = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield pool.exitPool(signer, amountIn, amountOut.split(","), false);
    console.log(res);
});
exports.default = exitPool;
//# sourceMappingURL=exitPool.js.map