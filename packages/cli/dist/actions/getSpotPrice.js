...
const getSpotPrice = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const price = yield pool.getSpotPrice(AssetIn, AssetOut, blockHash);
    console.log(`${price}`);
});
exports.default = getSpotPrice;
