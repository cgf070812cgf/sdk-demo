...
const cancelPendingMarket = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield market.cancelAdvised(signer, false);
    console.log(res);
    return;
});
exports.default = cancelPendingMarket;
//# sourceMappingURL=cancelPendingMarket.js.map